...
%define main_release 1%{?dist}.ngx.pagespeed
...
Source15: %{nps_version}-x64.tar.gz
...
%changelog
* Fri Feb 17 2017 CentOS Up repo <centosup@centosup.ispsystem.info>
- Added ngx_pagespeed google module
- Remove debug (PSOL does not support it)
...
* Tue Oct 18 2016 Konstantin Pavlov <thresh@nginx.com>
- 1.10.2
